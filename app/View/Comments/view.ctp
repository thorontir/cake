...
<h2><?php  echo __('Comment');?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($comment['Match']['id'], array('controller' => 'matches', 'action' => 'view', $comment['Match']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Date Posted'); ?></dt>
		<dd>
			<?php echo h($comment['Comment']['date_posted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
