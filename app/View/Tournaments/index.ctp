<div class="tournaments index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tournament['Tournament']['id']), null, __('Are you sure you want to delete %s?', $tournament['Tournament']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
