<div class="replays index">
	...
	<tr>
		<td><?php echo h($replay['Replay']['id']); ?>&nbsp;</td>
		<td><?php echo h($replay['Replay']['name']); ?>&nbsp;</td>
		<td><?php echo h($replay['Replay']['type']); ?>&nbsp;</td>
		<td><?php echo h($replay['Replay']['size']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $replay['Replay']['id']), null, __('Are you sure you want to delete # %s?', $replay['Replay']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
